...
type EventName = 'fusedLocation' | 'fusedLocationError' | 'fusedLocationStatus';
...
export default {
    ...
    on: (eventName: EventName, cb: LocationCallback): Subscription => {
        checkforAndroid();
        if (eventName != 'fusedLocation' && eventName != 'fusedLocationError' && eventName != 'fusedLocationStatus') {
